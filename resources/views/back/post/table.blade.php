...
<tr id="blog-bulk-delete">
    ...
    <td>
        <img src="{{ isset(json_decode($data->photo,true)[0]) ?  asset('assets/images/'.json_decode($data->photo,true)[0]) : asset('assets/images/placeholder.png')}}"
            alt="">
    ...
    <td>
        <div class="action-list">
            <a class="btn btn-secondary btn-md " href="{{ route('back.post.edit',$data->id) }}">
