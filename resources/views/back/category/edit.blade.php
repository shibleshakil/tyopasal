        ...
        <div class="card">
            <div class="card-body">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <h3 class="mb-0 pl-3"><b>{{ __('Update Category') }}</b> </h3>
                    <a class="btn btn-primary btn-md" href="{{ route ('back.category.index') }}"><i class="fa fa-chevron-left"></i> Back</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card o-hidden border-0 shadow-lg">
                    <div class="card-body ">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <form class="admin-form form" action="{{ route('back.category.update',$category->id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <img class="admin-img" src="{{ $category->photo ? asset('assets/images/'.$category->photo) : asset('assets/images/placeholder.png') }}"
                                            alt="No Image Found">
                                        <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_keywords" class="tags" id="meta_keywords"
                                            placeholder="{{ __('Enter Meta Keywords') }}" value="{{$category->meta_keywords}}">
                                    </div>
