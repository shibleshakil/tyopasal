                    ...
                    <div id="recent-buyers" class="media-list height-300 position-relative">
                        <a href="#" class="media border-0">
                            <div class="media-left pr-1">
                                <div class="avatar avatar-online avatar-md"><img
                                        ...
                                        src="{{ asset ('public/back/app-assets/images/portrait/small/avatar-s-7.png')}}"
                        ...
                        <a href="#" class="media border-0">
                            <div class="media-left pr-1">
                                <div class="avatar avatar-away avatar-md"><img
                                        class="media-object rounded-circle"
                                        src="{{ asset ('public/back/app-assets/images/portrait/small/avatar-s-8.png')}}"
                                        alt="Generic placeholder image">
                                    <i></i>
                                </div>
                            </div>
                        ...
                        <a href="#" class="media border-0">
                            <div class="media-left pr-1">
                                <div class="avatar avatar-busy avatar-md"><img
                                        class="media-object rounded-circle"
                                        src="{{ asset ('public/back/app-assets/images/portrait/small/avatar-s-9.png')}}"
                                        alt="Generic placeholder image">
                                    <i></i>
                                </div>
                            </div>
                        ...
                        <a href="#" class="media border-0">
                            <div class="media-left pr-1">
                                <div class="avatar avatar-online avatar-md"><img
                                        class="media-object rounded-circle"
                                        src="{{ asset ('public/back/app-assets/images/portrait/small/avatar-s-10.png')}}"
                                        alt="Generic placeholder image">
                                    <i></i>
                                </div>
                            </div>
                        ...
                        <a href="#" class="media border-0">
                            <div class="media-left pr-1">
                                <div class="avatar avatar-online avatar-md"><img
                                        class="media-object rounded-circle"
                                        src="{{ asset ('public/back/app-assets/images/portrait/small/avatar-s-11.png')}}"
                                        alt="Generic placeholder image">
                                    <i></i>
                                </div>
                            </div>
                        ...
                        <a href="#" class="media border-0">
                            <div class="media-left pr-1">
                                <div class="avatar avatar-away avatar-md"><img
                                        class="media-object rounded-circle"
                                        src="{{ asset ('public/back/app-assets/images/portrait/small/avatar-s-12.png')}}"
                                        alt="Generic placeholder image">
                                    <i></i>
                                </div>
                            </div>
                        ...
                        <table id="recent-orders"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-truncate"><span class="badge badge-success">Paid</span>
                                    </td>
                ...
                <div class="card-footer">
                    ...
                    <div class="chart-stats text-center">
                        <a href="#" class="btn btn-sm btn-primary mr-1">Statistics <i
                                class="feather icon-bar-chart"></i></a> <span class="text-muted">for the
                            last year.</span>
                    </div>
                </div>
            </div>
                        ...
                        <div class="tweet-slider">
                            <ul>
                                ...
                                <li>Are there <span class="yellow">#common-sense</span> facts related to
                                    your business? Combine them with a great photo.
                                    <p class="text-italic pt-1">- John Doe</p>
                                </li>
                            </ul>
                        </div>
    ...
    <div class="row match-height">
                                                ...
                                                <div class="media">
                                                    <div class="media-left">
                                                        <img class="media-object img-xl mr-1"
                                                            src="{{ asset ('public/back/app-assets/images/portrait/small/avatar-s-5.png')}}"
                                                            alt="Generic placeholder image">
                                                    </div>
        ...
        <div class="col-xl-4 col-lg-12">
            <div class="card">
                ...
                <div class="card-content">
                    <img class="img-fluid" src="{{ asset ('public/back/app-assets/images/carousel/06.jpg')}}"
                        alt="Card image cap">
                    <div class="card-body">
