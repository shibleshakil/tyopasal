        ...
        <div class="card">
            <div class="card-body">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <h3 class="mb-0 pl-3"><b>{{ __('Update Sub category') }}</b> </h3>
                    <a class="btn btn-primary btn-md" href="{{ route ('back.subcategory.index') }}"><i class="fa fa-chevron-left"></i> Back</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card o-hidden border-0 shadow-lg">
                    <div class="card-body ">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <form class="admin-form form" action="{{ route('back.subcategory.update',$subcategory->id) }}" method="POST"
